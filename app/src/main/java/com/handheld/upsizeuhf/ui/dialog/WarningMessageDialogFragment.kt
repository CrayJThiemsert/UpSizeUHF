...
class WarningMessageDialogFragment : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String, param3: String) : WarningMessageDialogFragment   {
            val fragment = WarningMessageDialogFragment()
            val args = Bundle()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view: View = inflater.inflate(R.layout.dialog_warning_message, null)
